def Silabus():
    data_silabus = [
        ...
        },
        {
            'title':'Programming 1',
            'silabus':'T',
            'silabus_list':["Definition and components of computer programs, algorithms, data structures and programming languages.","Stages of problem solving, structured programming concepts and presentation techniques algorithm.","Simple algorithm on single data, case study of prime checking, determining GCD & LCM and conversion of number system.","Introduction Data Structure and Language Programming C ++, Input / Output Statement Identifier / Identifier, Data Types, Operators.","Algorithm Structure / Computer Program, sequential, control statements, branching statements, nested control statement.","Array data type, Introduction and array declaration, Accessing data on array, Working with many arrays, 2D Matrices / arrays. Data type array.","Data record / struct type, Struct declaration, Access data record / struct.","Modular Programming / Subprogramming, Definition of subprogram / function, global and local variables, Formal and actual parameters, Recursive Definition, Recursive Subprogram.","Sorting and Searching, Methods of sorting data (insertion sort, selection sort, bubble sort, merge sort, quick sort), data search algorithm (linear search, binary search).","Pointer data type, dynamic data structure, pointer declaration, Use of pointer on linked list."]
        },
        {
        ...
        {
            'title':'Capita Selecta on Genetic Algorithm',
            'silabus':'T',
            'silabus_list':["Introduction to Genetic Algorithms, Overview of processes in algorithms, simple genetic algorithm cycles, holland scheme theorem","Genetic Algorithm Encoding, Overview of Genetic Algorithm Operators","Selection Process, Case Study","Cross Over Process, Case Study","Mutation Process, Case Study","Case Study: Scheduling, Bin Packing Problem","Case Study: Networking, Task Presentation","Evolutionary Strategy, Evolutionary Programming, Genetic Programming, Set Covering Problem","Minimum Spanning Tree, Knapsack Problem"]
        }
    ]
    return data_silabus