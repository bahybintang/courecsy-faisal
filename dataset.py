def Silabus():
    data_silabus = [
        ...
        },
        {
            ...
            'silabus':'T',
            'silabus_list':["Introductory lectures. Organization and architecture of computers, structures and functions.","Computer evolution and performance. Know the history and development of computers. Computer architecture design. Von Neum Neural Networks Architecture. Computer performance.","Central Processing Unit (CPU). Instructions, operands and operators, addressing. Assembler language.","The control unit. Operation of the control unit, single bus system. Micro control system.","Memory management. Cached memory (cache), internal memory, external memory. Virtual memory, allocation, segmentation, paging, maping.","Input / Output Management. Output input device. Interrupt system, Direct Memory Access (DMA), Interface of the assistive device.","Computer Arithmetic. Arithmetic logic unit (ALU), representation of numbers and arithmetic (integer, floating-point).","Parallel computers. pipeline instructions. multiprocessor and supercomputer."]
        },
        {
            'title':'Database',
            'silabus':'T',
        ...
        },
        {
            ...
            'silabus':'T',
            'silabus_list':["Analysis of algorithm.","Asymptotic notations.","Recurrence.","Devide and Conquer: maximum and minimum, multiplication of integers, Quicksort.","Heapsort.","Sorting with linear time and Order Statistics.","Probabilistic analysis and random algorithm.","Amortized Analysis.","Theory Complexity: how fast we can compute.","Basic Theory Complexity.","Classical Complexity Theory."]
        },
        {
        ...
        },
        {
            ...
            'silabus':'T',
            'silabus_list':["Introduction to Compiler, BNF grammars and parse trees","Lexical Analysis","Syntax Analysis","Top-Down Parsing, Part I","Top-Down Parsing, Part II","Bottom-up Parsing, Part I","Bottom-up Parsing, Part II","Advanced Parcing","Semantic Analysis","Type-Checking","Code Generation","Runtime Environment","Local and Global Optimization","Code Optimization"]
        },
        {
            'title':'Queue and Simulation',
            'silabus':'T',
            'silabus_list':["Basic Simulation Modeling: System, Model, and Simulation, discrete- event simulation, single server queue server simulation, distributed simulation, simulation steps, other types of simulations.","Modeling of complex systems cases","Software simulation","Establish valid and reliable simulation models: some valid simulation model principles, verification of simulated computer programs, a three-step approach to development of valid and reliable simulation models, statistical procedures for real-world observation calculations and output data of simulation;","Random Number Generator","Formation of random variables: common approaches for the formation of random variables, the formation of continuous variables, the formation of random variables.","Simulation of Manufacture Systems"]
        },
        {
        ...
        },
        {
            ...
            'silabus':'T',
            'silabus_list':["Concepts and terminology of parallel systems, Utilization of parallel systems, Examples of parallel systems","Parallel computer memory architecture: Shared memory, Distributed memory, Hybrid distributed-shared memory","Parallel programming model","Parallel program design","Examples of problems and parallel programs"]
        },
        {
        ...
        },
        {
            ...
            'silabus':'T',
            'silabus_list':["Introduction: Why Neural Networks; What is a Neural Networks; Where are Neural Networkss being used? ; How Neural Networks Used ?; Who is developing Neural Networks; When Neural Networks Began: the McCullock; Suggestion for futher study","Simple Neural Nets for Pattern Classification. : General Architecture; Hebb Net; Perceptron; Adeline","Pattern Association: Heteroassociative memory; Associative Net; Iterative Autoassociative Net; Bidirectional Associative Memory;","Fixed-Weight Competitive Nets; Kohonen Self-Organizing Map; Learning vector Quantitation; Counterpropagation","Adaptive Resonance Theory","Backpropagation (BP) Neural Net: BP Standard; Variation; Theoritical Results;","Adaptive Architecture; Neocognitron"]
        },
        {
            'title':'Fuzzy Logic',
            'silabus':'T',
        ...
        },
        {
            ...
            'silabus':'T',
            'silabus_list':["The structure of the pattern recognition system.The pattern and extraction of its main features (feature).","Supervised learning, unsupervised learning","Syntactic pattern recognition","Artificial neural network pattern","Vague logical-based pattern recognition","Examples for the four pattern recognition groups."]
        },
        {
        ...
        },
        {
            ...
            'silabus':'T',
            'silabus_list':["Introduction to Genetic Algorithms, holland schema theorem","Genetic Algorithm Encoding, Overview of Genetic Algorithm Operators","Selection Process ","Cross Over Process, ","Mutation Process ","Scheduling, Bin Packing Problem","Networking, Task Presentation","Evolutionary Strategy, Evolutionary Programming, Genetic Programming, Set Covering Problem","Minimum Sp Neural Networksing Tree, Knapsack Problem"]
        }
    ]
    return data_silabus